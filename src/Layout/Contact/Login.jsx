...
const Login = () => {
  ...
  <div className=" md:w-auto w-[90%] p-8 rounded-xl  m-4 flex flex-col items-center shadow-lg border bg-[#d9f99d] opacity-90 ">
    ...
    <div className="text-center mt-7 flex flex-col gap-3">
      ...
      <button className="uppercase px-24 md:px-[118px] lg:px-[140px] py-2 rounded-md text-white bg-[#244034] flex items-center gap-4 font-medium "><BiLogoGoogle className="bg-white rounded text-black"/> login with google</button>
