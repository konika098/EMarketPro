...
const Error = () => {
  ...
  <div className="flex-col space-y-4 text-left px-6">
    ...
    <div className="flex space-x-4 items-center justify-start">
      <Link to="/"><div className="bg-violet-700 px-4 py-1 text-white font-medium border-2 border-gray-400  hover:scale-105 cursor-pointer"><ion-icon name="arrow-back-sharp" /></div></Link>
